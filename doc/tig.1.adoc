...
TIG_TRACE::
	Path for trace file where information about Git commands is logged.
...
TIG_NO_DISPLAY::
	Open Tig without rendering anything to the terminal. This forces Ncurses
...
TIG_EDITOR::
	...
	allows using a different editor from the one Git uses. The
