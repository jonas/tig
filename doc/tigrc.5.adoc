...
date::
	- 'display' (mixed)
	  [relative|relative-compact|short|default|local|<bool>]: How to display
	  dates. If set to "relative" or "relative-compact" a relative date will
	  be used, e.g. "2 minutes ago" or "2m". If set to "short" no time
