...
'mouse-scroll' (int)::
	...
	Note that mouse support requires that ncurses itself has mouse support.
...
'mouse' (bool)::
	Whether to enable mouse support. Note that mouse support requires that
	ncurses itself has mouse support.
