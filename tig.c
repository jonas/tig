...
LINE(DIFF_INDEX,	"index ",	  COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
...
LINE(DIFF_TREE,		"diff-tree ",	  COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
LINE(PP_AUTHOR,	   "Author: ",		COLOR_CYAN,	COLOR_DEFAULT,	0), \
LINE(PP_COMMIT,	   "Commit: ",		COLOR_MAGENTA,	COLOR_DEFAULT,	0), \
LINE(PP_MERGE,	   "Merge: ",		COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
...
LINE(PARENT,	   "parent ",		COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
LINE(TREE,	   "tree ",		COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
...
LINE(DATE,         "",			COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
...
LINE(HELP_GROUP,   "",			COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
LINE(BLAME_ID,     "",			COLOR_MAGENTA,	COLOR_DEFAULT,	0), \
LINE(DIFF_STAT,		"",	  	COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD), \
...
LINE(GRAPH_COMMIT, "",			COLOR_BLUE,	COLOR_DEFAULT,	A_BOLD)
