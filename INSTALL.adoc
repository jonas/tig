...
https://github.com/jonas/tig/releases/download/tig-2.2.1/tig-2.2.1.tar.gz[tig-2.2.1]
https://github.com/jonas/tig/releases/download/tig-2.2.1/tig-2.2.1.tar.gz.md5[(md5)]
...
If you have install ncurses with brew, run configure with the following
...
|gsed (i.e. GNU sed)		|Required for running the test suite.
				 Can be installed with `brew install gnu-sed`
				 on OS X.
